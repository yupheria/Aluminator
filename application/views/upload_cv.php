...
<head>
    ...
    <title>Alumniator | Upload CV</title>
	<!-- BOOTSTRAP STYLES-->
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                 ...
                 <div class="col-lg-6">
                 <?php
				  echo form_open_multipart('upload/do_upload',array('class'=>'reg-page'));
				 ?>
                <?php
if(isset($error)){
	echo $error;
...
?>
                  ...
                  <label>CV</label>
				  <label>firstname.lastname format please</label>
				...
				<input type="file" name="userfile" size="20" />
                 <button type="submit" class="btn btn-primary" style="margin-top:20px;">Upload CV</button>
                 </div>
