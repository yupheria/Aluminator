    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <!-- /.col-md-8 -->
                <div class="col-md-4">
                    <h1>Welcome to WelTec Alumni</h1>
                    <p>This is the WelTec Alumni and here you can register here as a alumni. This is a good platform for the users to get interact with each other by chatting, posting and commenting.</p>
