        ...
        <div class="container content">		
            <div class="row">
                <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3">
                    <?php echo form_open('login/validation', array('class' => 'reg-page')); ?>
                    ...
                    <button class="btn-u" type="submit">Login</button> </li>
							
                    </form>   
					<?php echo form_open('login/forget_password', array('class' => 'reg-page')); ?>
						<button class="btn-u" type="submit">Forgot Password</button> </li>
					</form>
            </div><!--/row-->
        </div>
    </body>
