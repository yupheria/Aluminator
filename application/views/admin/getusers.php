           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li>
                          <?php echo  anchor('admin/get_users','Get Users', array('class'=>'active-menu')); ?> 
                    </li>
						   <li>
            ...
            <div id="page-inner">
                <div class="row">
				 ...
				 foreach($gusers as $gu){
					 echo'<tr>';
					 echo'<td>';
					  echo '<div class="image"><img class=" img-responsive" width="50px" height="65px" src="'.base_url().'/webroot/images/user_images/'.$gu->image.'" ></div></td>';
					 echo '<td>'.$gu->firstname .'&nbsp;'. $gu->lastname .'</td>';
					 echo '<td>'.$gu->gender.'</td>';
					 echo '<td>'.$gu->created_on.'</td>';
					 echo '<td>'.$gu->status.'</td>';
					 echo '</tr>';
				 }
				 ?>
                </table>
