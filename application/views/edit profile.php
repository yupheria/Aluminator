...
<head>
    ...
    <title>Alumniator | Edit Profile</title>
	<!-- BOOTSTRAP STYLES-->
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                 ...
                 <div class="col-lg-6">
                 <?php
				  echo form_open('users/update_profile',array('class'=>'reg-page'));
				 ?>
                 <div id="error" style="color:#F00;"><p><?php echo validation_errors(); ?></p></div>
                 ...
                 <input type="text" class="form-control" name="lastname" value="<?php echo $r->lastname;?>">
                  ...
                  <textarea class="form-control" rows="3" name="about" ><?php echo $r->about;}?></textarea><br />
               ...
               <!--  <input type="file" name="image_file" value="">-->
				 ...
				 <label>CV</label>
				 <?php echo  anchor('users/upload_cv_f	orm','Upload CV'); ?><br />
				 <label>Change Password</label>
				 <?php echo  anchor('users/update_password','Change Password'); ?>
				 <br />
