        ...
        <div class="container content">		
            <div class="row">
                <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3">
                    <?php echo form_open('login/forgot_email_method', array('class' => 'reg-page')); ?>
                    <div class="reg-header">            
                        <h2>Enter email for verification</h2>
						<div id="error"><p><?php echo validation_errors(); 
                    ...
                    <div class="input-group margin-bottom-20">
                        ...
                        <input type="text" placeholder="Enter_Email" name="forgot_email" class="form-control">
                    </div>                  
						<button class="btn-u" type="submit">Send Email</button> </li>
                    </form>   
            </div><!--/row-->
        </div>
    </body>
