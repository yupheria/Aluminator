           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
					...
					<li>
                        <?php echo  anchor('chat','Chat Online', array('class'=>'active-menu')); ?>
                    </li>
            ...
            <div id="page-inner">
              ...
              <div class="post_display">
                 ...
                 <div class="panel-body">
                  <div id="error"><p><?php echo $this->session->flashdata('NotOnline');?></p></div>
                 <?php
					 ...
					 foreach($get_my_friendsone as $flist){
						 ...
						 echo anchor('chat/chater_check/'.$flist->friend_id.'',''.$flist->friend_name).'<br>';
					 }
					 }
				  ...
				  foreach($get_my_friends2 as $flist1){
						 ...
						 echo anchor('chat/chater_check/'.$flist1->user_id.'',''.$flist1->user_name).'<br>';
					 }
				  }
				 ?>
